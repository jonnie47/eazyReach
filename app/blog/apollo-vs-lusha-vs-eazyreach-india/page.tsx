                ...
                <article className="max-w-3xl mx-auto px-4 pt-32 pb-20">
                    ...
                    <div className="mt-12 p-6 bg-yellow-400/5 border border-yellow-400/20 rounded-2xl text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 justify-center">
                            <Link href="/get-started" target="_blank" className="px-6 py-2.5 bg-yellow-400 text-black font-semibold rounded-xl hover:bg-yellow-300 transition-colors text-sm">
                                Try EazyReach Free
                            </Link>
